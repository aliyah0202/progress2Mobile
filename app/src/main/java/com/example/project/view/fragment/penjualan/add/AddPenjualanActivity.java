...
public class AddPenjualanActivity extends AppCompatActivity {
    ...
    public static void startActivity(Context context, boolean isEdit, ModelDatabase penjualan) {
        Intent intent = new Intent(new Intent(context, AddPenjualanActivity.class));
        intent.putExtra(KEY_IS_EDIT, isEdit);
        intent.putExtra(KEY_DATA, penjualan);
        context.startActivity(intent);
    }
    private AddPenjualanViewModel addPenjualanViewModel;
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        addPenjualanViewModel = ViewModelProviders.of(this).get(AddPenjualanViewModel.class);
    ...
    private void loadData(){
        ...
        if (mIsEdit){
            ModelDatabase penjualan = getIntent().getParcelableExtra(KEY_DATA);
            if (penjualan != null){

                strId = penjualan.uid;
                String keterangan = penjualan.keterangan;
                String tanggal = penjualan.tanggal;
                int uang = penjualan.jmlUang;
    ...
    private void initAction() {
        etTanggal.setOnClickListener(view -> {
            ...
            new DatePickerDialog(AddPenjualanActivity.this, date,
        ...
        btnSimpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (strKeterangan.isEmpty() || strTanggal.isEmpty() || strJmlUang.isEmpty()) {
                    Toast.makeText(AddPenjualanActivity.this, "Ups, form tidak boleh kosong!",
                            Toast.LENGTH_SHORT).show();
                }else {
                    if (mIsEdit){
                        addPenjualanViewModel.updatePenjualan(strId, strKeterangan, strTanggal,
                                Integer.parseInt(strJmlUang));
                    }else{
                        addPenjualanViewModel.addPenjualan(strTipe, strKeterangan, strTanggal,
                                Integer.parseInt(strJmlUang));
                    }
                    finish();
                }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            startActivity(new Intent(AddPenjualanActivity.this, Penjualan.class));
            return true;
        }
