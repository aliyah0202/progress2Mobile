...
public class PenjualanAdapter extends RecyclerView.Adapter<PenjualanAdapter.ViewHolder>{
    ...
    private PenjualanAdapterCallback mAdapterCallback;

    public PenjualanAdapter(Context context, List<ModelDatabase> list, PenjualanAdapterCallback adapterCallback) {
    ...
    public void addData(List<ModelDatabase> pembelians) {
        this.list = pembelians;
        ...
        ViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ModelDatabase penjualan = list.get(getAdapterPosition());
                    mAdapterCallback.onEdit(penjualan);
                }
            });
            ...
            ivDelete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ModelDatabase penjualan = list.get(getAdapterPosition());
                    mAdapterCallback.onDelete(penjualan);
                }
            });
        }
    ...
    public interface PenjualanAdapterCallback {
